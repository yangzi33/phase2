...
public class EventManager {
        ...
        public void viewAllEvents(){
                ...
                if(n  == 0){
                        ...
                        for (int i = 0; i < n; i++){
                                int number = i + 1;
                                System.out.println("event.Event" + number + ": " + allEvents.get(i).getEventName());
        ...
        public void viewOptions(ArrayList<Event> events){
                int n = events.size();
                if(n  == 0){
                        ...
                        for (int i = 0; i < n; i++){
                                int number = i + 1;
                                System.out.println("event.Event" + number + ": " + events.get(i).getEventName());
